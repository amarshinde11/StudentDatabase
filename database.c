...
void GetMarks( STD_DETAILS_S * info )
{
    ...
    float TotalMarks = 650;
    printf("Enter the marks of (CWT1+LAB)(MAX = 100): ");
    scanf("%f", &cwt1);
    printf("Enter the marks of (CWT2+LAB)(MAX = 100): ");
    scanf("%f", &cwt2);
    printf("Enter the marks of (CMT+LAB) (MAX = 100): ");
    scanf("%f", &cmt);
    printf("Enter the marks of AWT (MAX = 50): ");
    scanf("%f", &awt);
    printf("Enter the marks of (AMT+LAB)  (MAX = 100): ");
    scanf("%f", &amt);
    printf("Enter the marks of (CppWT+LAB)(MAX = 100): ");
    scanf("%f", &cppwt);
    printf("Enter the marks of (CppMT+LAB)(MAX = 100): ");
    scanf("%f", &cppmt);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
*****************************************************************************************************************/
void SearchDetailsByNameOrAssessmentSts( int (*FunPtr)(const char *, const char *), const char * replacement )
{
    ...
    while( files <= Batch_9 )
    {
       switch( files )
       {
           case Batch_1: records = FunPtr("v22be1.txt", replacement);
                        count += records;
           break;
           case Batch_2: records = FunPtr("v22be2.txt", replacement);
                        count += records;
           break;
           case Batch_3: records = FunPtr("v22be3.txt", replacement);
                        count += records;
           break;
           case Batch_4: records = FunPtr("v22be4.txt", replacement);
                        count += records;
           break;
           case Batch_5: records = FunPtr("v22be5.txt", replacement);
                        count += records;
           break;
           case Batch_6: records = FunPtr("v22be6.txt", replacement);
                        count += records;
           break;
           case Batch_7: records = FunPtr("v22be7.txt", replacement);
                        count += records;
           break;
           case Batch_8: records = FunPtr("v22be8.txt", replacement);
                        count += records;
           break;
           case Batch_9: records = FunPtr("v22be9.txt", replacement);
                        count += records;
           break;
       }
       files++;
...
void EditFileDataWithCorrectInfo( void )
{
    ...
    switch( fields )
    {
        case Edit_ID: /* edit the batch id of student */
                EditStudentsData( EditStudentsBatchId, Edit_ID );
        break;
        case Edit_Name: /* edit the name of student */
                EditStudentsData( EditStudentsName, Edit_Name );
        break;
        case Edit_Marks: /* Edit the avg marks */
                EditStudentsData( EditStudentsMarks, Edit_Marks );
        break;
        case Edit_ASts: /* edit the assessment status */
                EditStudentsData( EditAsessmentSts, Edit_ASts );
        break;
...
/////////////////////////////////////////////////////////////////////////////////////////////////
*
* void EditStudentsData( int(*FunPtr)( FILE *, STD_DETAILS_S * ), EditField field ): This is
* a function calls one of the function to edit different fields in students data depends on
* one of the parameter as function pointer.
*
/////////////////////////////////////////////////////////////////////////////////////////////////
************************************************************************************************/
void EditStudentsData( int(*FunPointer)( FILE *, STD_DETAILS_S * ), EditField field )
{
    ...
    if( (info = malloc(sizeof(STD_DETAILS_S))) == NULL ) {
        printf("Memory not allocated for the structure.\n");
        return;
    }
    switch(field)
    {
        case Edit_Name: printf("Enter Batch Id:");
                        scanf(" %[^\n]",info->aca_info.batch_id);
                        printf("Enter DoB(dd:mm:yyyy): ");
                        scanf("%d%d%d", &dd, &mm, &yyyy );
                        info->d_birth.dd    = dd;
                        info->d_birth.mm    = mm;
                        info->d_birth.yyyy  = yyyy;
        break;
        case Edit_ID:   printf("Enter the name:");
                        scanf(" %[^\n]",info->aca_info.std_name);
                        printf("Enter DoB(dd:mm:yyyy): ");
                        scanf("%d%d%d", &dd, &mm, &yyyy );
                        info->d_birth.dd    = dd;
        ...
        break;
        case Edit_ASts:
        case Edit_Marks:printf("\nVerify Batch Id and Name\n");
                        printf("Enter the batch id: ");
    ...
    if( done == FAIL )
        printf("The student's info not found in database\n");
    else
        printf("The data updated successfully.\n");
...
///////////////////////////////////////////////////////////////////////////////////////////////////
*
* int EditAsessmentSts( FILE * fp, STD_DETAILS_S * info ): This is function to edit the Assessment
* status of student, before that it will verify the student's name and Batch Id.
*
///////////////////////////////////////////////////////////////////////////////////////////////////
**************************************************************************************************/
    ...
    while( fscanf(fp, " %[^\n]", buf) != EOF )
    {
            if( my_strstr(buf, info->aca_info.batch_id) != NULL ) {
                if( my_strstr(buf, info->aca_info.std_name) != NULL )
                {
                        ...
                        printf("Enter the current status to update: ");
                        scanf(" %[^\n]", sts);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
*
* int EditStudentsMarks( FILE * fp, STD_DETAILS_S * info ): This is function to edit the avg marks
* of student, before that it will verify the student's name and Batch Id.
*
///////////////////////////////////////////////////////////////////////////////////////////////////
**************************************************************************************************/
...
///////////////////////////////////////////////////////////////////////////////////////////////////
*
* int EditStudentsName(FILE * fp, STD_DETAILS_S * info ): This is function to edit the name of
* student, before that it will verify the student's Batch Id and Date of Birth.
*
///////////////////////////////////////////////////////////////////////////////////////////////////
**************************************************************************************************/
int EditStudentsName(FILE * fp, STD_DETAILS_S * info )
{
    ...
    while( fscanf(fp, " %[^\n]", buf) != EOF )
    {
        ...
        if( match == SUCCESS )
        {
            ...
            fseek(fp, -len, SEEK_CUR);    /*bring current position indicator */
            fprintf(fp, "%s", buf);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
*
* int EditStudentsBatchId( FILE * fp, STD_DETAILS_S * info ): This is function to edit Batch Id of
* student, before that it will verify the student's Name and Date of Birth.
*
///////////////////////////////////////////////////////////////////////////////////////////////////
**************************************************************************************************/
